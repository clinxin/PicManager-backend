...
import com.clinxin.picmanagerbackend.api.alliyunai.model.GetOutPaintingTaskResponse;
import com.clinxin.picmanagerbackend.api.imagesearch.ImageSearchApiFacade;
...
import com.clinxin.picmanagerbackend.manager.auth.StpKit;
...
import com.clinxin.picmanagerbackend.model.vo.PictureTagCategory;
...
//            }
    ...
    public BaseResponse<Page<PictureVO>> listPictureVOByPageWithCache(@RequestBody PictureQueryRequest pictureQueryRequest,
        ...
        String cacheKey = String.format("picmanager:listPictureVOByPageWithCache:" + hashKey);
        ...
        // 4.1 更新 Redis 缓存，设置缓存的过期时间，5分钟过期，防止雪崩
    ...
    @SaSpaceCheckPermission(value = SpaceUserPermissionConstant.PICTURE_EDIT)
    public BaseResponse<?> editPictureByBatch(@RequestBody PictureEditByBatchRequest pictureEditByBatchRequest,
                                              HttpServletRequest request) {
