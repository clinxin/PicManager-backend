package com.clinxin.picmanagerbackend.manager.auth;
...
import com.clinxin.picmanagerbackend.model.enums.SpaceRoleEnum;
import com.clinxin.picmanagerbackend.model.enums.SpaceTypeEnum;
...
import static com.clinxin.picmanagerbackend.constant.UserConstant.USER_LOGIN_STATE;
...
public class StpInterfaceImpl implements StpInterface {
    ...
    /**
     * 返回一个账号所拥有的权限码集合（梳理好逻辑后，通过 AI 生成代码，再改改改 ~）
     */
    @Override
    ...
    private SpaceUserAuthContext getAuthContextByRequest() {
        ...
        if (ObjectUtil.isNotNull(id)) {
            // 获取到请求路径的业务前缀,例如 api/picture/space/xxx?xxx=1
    ...
    private boolean isAllFieldsNull(Object object) {
        ...
        // 获取所有字段并判断是否所有字段都为空
        return Arrays.stream(ReflectUtil.getFields(object.getClass())) // 运用反射，动态地获取对象所有的字段信息
                // 获取字段值，通过反射工具类拿到对象中每个字段的值
                .map(field -> ReflectUtil.getFieldValue(object, field))
                // 检查是否所有字段都为空，allMatch 所有字段都为空，才会返回 true
