package com.clinxin.picmanagerbackend.manager.websocket;

import cn.hutool.core.collection.CollUtil;
import cn.hutool.json.JSONUtil;
import com.clinxin.picmanagerbackend.manager.websocket.disruptor.PictureEditEventProducer;
import com.clinxin.picmanagerbackend.manager.websocket.model.PictureEditActionEnum;
import com.clinxin.picmanagerbackend.manager.websocket.model.PictureEditMessageTypeEnum;
import com.clinxin.picmanagerbackend.manager.websocket.model.PictureEditRequestMessage;
import com.clinxin.picmanagerbackend.manager.websocket.model.PictureEditResponseMessage;
...
public class PictureEditHandler extends TextWebSocketHandler {
    ...
    private void broadcastTopicture(Long pictureId, PictureEditResponseMessage pictureEditResponseMessage, WebSocketSession excludeSession) throws IOException {
        ...
        if (CollUtil.isNotEmpty(sessionSet)) {
            ...
            module.addSerializer(Long.TYPE, ToStringSerializer.instance); // 支持 long 类型
